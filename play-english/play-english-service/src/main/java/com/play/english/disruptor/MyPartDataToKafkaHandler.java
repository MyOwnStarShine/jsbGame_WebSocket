 ...
 * @author chaiqx
 */
public class MyPartDataToKafkaHandler implements EventHandler<MyPartingDataEvent> {
    ...
    public void onEvent(MyPartingDataEvent myPartingDataEvent, long l, boolean b) throws Exception {
        ...
        System.out.println(String.format("thread %s part data into kafka, carId = %s, seq = %s", threadId, carId, l));
    }
}
