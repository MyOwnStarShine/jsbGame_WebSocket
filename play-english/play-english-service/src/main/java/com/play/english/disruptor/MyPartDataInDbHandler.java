 ...
 * @author chaiqx
 */
public class MyPartDataInDbHandler implements EventHandler<MyPartingDataEvent> {
    ...
    public void onEvent(MyPartingDataEvent myPartingDataEvent, long l, boolean b) throws Exception {
        ...
        System.out.println(String.format("thread %s part data into db, carId = %s, seq = %s", threadId, carId, l));
    }
}
